 ...
 * 
 */
package com.orbc.session.service.impl;

import static com.orbc.session.constants.AppConstants.ACAP_KEY;
import static com.orbc.session.constants.AppConstants.ACCC_KEY;
import static com.orbc.session.constants.AppConstants.ACCC_VAL;
import static com.orbc.session.constants.AppConstants.ACCT_KEY;
import static com.orbc.session.constants.AppConstants.CLGR_KEY;
import static com.orbc.session.constants.AppConstants.CLID_KEY;
import static com.orbc.session.constants.AppConstants.CLID_VAL;
import static com.orbc.session.constants.AppConstants.CLPASS_KEY;
import static com.orbc.session.constants.AppConstants.CLRTK_KEY;
import static com.orbc.session.constants.AppConstants.CLSE_KEY;
import static com.orbc.session.constants.AppConstants.CLSE_VAL;
import static com.orbc.session.constants.AppConstants.CLTX_KEY;
import static com.orbc.session.constants.AppConstants.CLTX_VAL;
import static com.orbc.session.constants.AppConstants.CLUSR_KEY;
import static com.orbc.session.constants.AppConstants.E_AF;
import static com.orbc.session.constants.AppConstants.E_CCC;
import static com.orbc.session.constants.AppConstants.E_SOF;
import static com.orbc.session.constants.AppConstants.HTTPS;
import static com.orbc.session.constants.AppConstants.SEC_TLS;
import static com.orbc.session.constants.AppConstants.SSO_TOKEN_URL;
import static com.orbc.session.util.Utils.clear;
import static com.orbc.session.util.Utils.isEmpty;
...
import com.orbc.session.exception.AuthenticationFailedException;
import com.orbc.session.exception.UserValidationException;
import com.orbc.session.service.ILoginService;
